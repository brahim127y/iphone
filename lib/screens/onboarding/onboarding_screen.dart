            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (!_codeVerified) ...[
                    // ÉTAPE 1 : Code de sécurité 453216
                    Container(
                    ...
                    // ÉTAPE 2 : Infos Boutique — Design Premium
                    // En-tête de section
                    Row(
                      children: [
                        Container(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              ...
                              style: GoogleFonts.outfit(color: AppColors.primary, fontSize: 11, height: 1.4),
                            ),
                          ),
                        ],
                      ),
                    ...
                    SizedBox(
                      ...
                      child: DecoratedBox(
                        ...
                        child: ElevatedButton.icon(
                          ...
                          label: Text(
                            _saving ? 'Enregistrement...' : 'Lancer l\'application',
                            style: GoogleFonts.outfit(
                              color: Colors.white,
                              fontSize: 16,
                              fontWeight: FontWeight.w700,
